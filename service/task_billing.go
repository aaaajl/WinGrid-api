...
func LogTaskConsumption(c *gin.Context, info *relaycommon.RelayInfo, task *model.Task) {
	...
	if info.DurationBilling != nil {
		other.SetPublic("billing_mode", "per_duration")
		other.SetPublic("size", info.DurationBilling.Size)
		other.SetPublic("duration", info.DurationBilling.Duration)
		other.SetPublic("base_price", info.DurationBilling.BasePrice)
		other.SetPublic("cost_usd", info.DurationBilling.CostUSD)
		other.SetPublic("used_fallback", info.DurationBilling.UsedFallback)
	}

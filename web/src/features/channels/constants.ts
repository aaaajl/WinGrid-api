...
const CHANNEL_TYPE_DISPLAY_ORDER: number[] = [
  ...
  5, 36, 50, 51, 52, 53, 54, 55, 56, 961, 962, 963,
]
...
export const CHANNEL_TYPE_WARNINGS: Record<number, string> = {
  ...
  963: 'The model, Endpoint URL, and API key must belong to the same region. Replace {WorkspaceId} with your real workspace ID.',
}

    ...
    async (values: ModelFormValues) => {
      ...
      try {
        ...
        const durationChanged =
          normalized.DurationPricing !==
          modelNormalizedDefaults.current.DurationPricing
        ...
        if (durationChanged) {
          await updateOption.mutateAsync({
            key: 'billing_setting.duration_pricing',
            value: normalized.DurationPricing,
          })
        }
        if (peakOffPeakChanged) {
          await updateOption.mutateAsync({
